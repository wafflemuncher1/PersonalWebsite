...
```bash
python3 .gemini/skills/ui-ux-pro-max/scripts/search.py "<query>" --design-system --persist -p "Project Name" --output-dir "<project-root>"
```
...
```bash
python3 .gemini/skills/ui-ux-pro-max/scripts/search.py "<query>" --design-system --persist -p "Project Name" --page "dashboard" --output-dir "<project-root>"
```
...
```bash
python3 .gemini/skills/ui-ux-pro-max/scripts/search.py "virtualized list" --stack react-native
```
...
```bash
python3 .gemini/skills/ui-ux-pro-max/scripts/search.py "streaming suspense" --stack nextjs
```
