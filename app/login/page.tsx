    ...
    <main className="relative flex min-h-screen items-center justify-center overflow-hidden px-6">
      ...
      <div className="relative z-10 w-full max-w-sm">
        ...
        <div className="glass rounded-2xl p-8 shadow-glow">
          ...
          <h1 className="mb-2 text-2xl font-semibold text-white">Sign in to Nocturne</h1>
          <p className="mb-6 text-sm text-zinc-400">
            This dashboard is locked to a single owner. Enter your email and we&apos;ll send a
            magic link — no password to remember or leak.
          </p>

          {status === "sent" ? (
            <div className="rounded-xl border border-violet-500/30 bg-violet-500/10 p-4 text-sm text-violet-200">
              Check <span className="font-medium text-white">{email}</span> for a sign-in link.
