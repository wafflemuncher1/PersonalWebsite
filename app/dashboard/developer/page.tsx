  ...
  return (
    <div className="mx-auto max-w-2xl space-y-6">
      ...
      <Link href="/dashboard/developer/users" className="block">
        <Card className="flex items-center gap-4 p-6 transition hover:border-violet-500/30 hover:bg-white/[0.04]">
          <span className="flex h-11 w-11 shrink-0 items-center justify-center rounded-full bg-violet-500/15 text-violet-300">
