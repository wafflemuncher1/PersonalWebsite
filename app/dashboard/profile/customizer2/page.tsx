...
import { DEFAULT_CUSTOMIZER2_SETTINGS } from "@/lib/customizer-presets";
import { ProfileCustomizer2 } from "@/components/customizer2/ProfileCustomizer2";
import type { Customizer2Settings, Profile } from "@/lib/types";
...
export default async function Customizer2Page() {
  ...
  const initialSettings: Customizer2Settings = {
    ...DEFAULT_CUSTOMIZER2_SETTINGS,
    ...(profile?.customizer2_settings ?? {}),
  };
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-1 text-sm text-zinc-500">
          An experimental, more advanced profile customizer — separate from your real Customize page. Nothing
          here affects your live public profile.
        </p>
      </div>
