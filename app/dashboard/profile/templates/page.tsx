        ...
        <Card className="p-6">
          ...
          <RevealGroup className="grid gap-3 sm:grid-cols-3" stagger={0.08}>
            {["Minimal", "Bold", "Gradient"].map((name) => (
              <RevealItem key={name}>
                <div className="group flex aspect-[3/4] flex-col items-center justify-center gap-2 rounded-xl border border-dashed border-white/10 bg-white/[0.02] text-center opacity-50 transition duration-300 ease-premium hover:opacity-70 hover:border-violet-500/25">
