  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-2 gap-4 lg:grid-cols-4">
        <StatTile label="Total link clicks" value={totalClicks.toLocaleString()} icon="🔗" />
        <StatTile label="Click rate" value={`${clickRate}%`} icon="🎯" />
        <StatTile label="Profile views" value={totalViews.toLocaleString()} icon="👁" />
        <StatTile label="Avg. daily views" value={avgDailyViews.toLocaleString()} icon="📈" />
      </div>
