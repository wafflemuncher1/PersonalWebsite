      ...
      <CardContent className="space-y-2">
        {ITEMS.map((item) => (
          <Link
            key={item.href}
            href={item.href}
            className="glass-inset group flex items-center gap-3 rounded-xl px-4 py-2.5 text-sm font-medium transition-all duration-200 ease-premium hover:translate-x-0.5 hover:border-primary/25 hover:bg-primary/[0.06]"
          >
